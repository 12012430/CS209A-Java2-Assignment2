...
public class Server {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("Room %d\tServer Address：%s\n",num,server.getLocalSocketAddress().toString());
            for (; ; ) {
                ...
                client1.setKeepAlive(true);
                BufferedReader in1 = new BufferedReader(new InputStreamReader(client1.getInputStream()));
                PrintStream out1 = new PrintStream(client1.getOutputStream());
                out1.printf("Welcome to the room %d, you are player 1, please wait for the other player to connect!\n",num);
                out1.flush();
            ...
            try {
                ...
                for(;;){
                    ...
                    if(str1.contains("23333")){
                        ...
                        if(status==0) System.out.println("Tie!");
                        else if(status==1) System.out.println("Player 1 wins!");
